...
const SecondPartyWalletScreen: React.FC<{ onContinue: () => void, onCancel: () => void }> = ({
  onContinue,
  onCancel
      ...
      <View>
        <View style={{
          ...
          <Text
            ...
            }} >Second Party’s Wallet Address</Text>
        </View>
          ...
          <View style={{
            ...
            >
              <TextInput style={{
                ...
                borderWidth: 0,
                fontSize: 14,
              }} placeholder={"Enter the second party’s name"} placeholderTextColor={"#EAF9FF"} />
            </LinearGradient>
          </View>
        </View>
        <View style={{
          ...
          >
            <TextInput style={{
              ...
              borderWidth: 0,
              fontSize: 14,
            }} placeholder={"Enter valid wallet address"} placeholderTextColor={"#EAF9FF"} />
          </LinearGradient>
        </View>
        <View style={{
          width: "100%",
