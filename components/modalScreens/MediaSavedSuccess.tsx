...
const MediaSavedSuccessModal: React.FC<AgreementSuccessfulProp> = ({
    isVisible,
    onClose,
}) => {
    return (
                ...
                >
                    <ModalContainer>
                        <View style={{
                            ...
                            <MaskedView maskElement={<TitleText>Your Media is Saved on the Blockchain</TitleText>}>
                                <GradientTitle colors={["#EAF9FF", "#8E9A9A"]}>
                                    <TitleText style={{ opacity: 0 }}>Your Media is Saved on the Blockchain</TitleText>
                                </GradientTitle>
                            </MaskedView>
...
export default MediaSavedSuccessModal;
